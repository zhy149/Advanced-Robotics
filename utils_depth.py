...
def LoadData(dataType):
    ...
    print("final frames shape", depth_frames.shape)
    ...
    if dataType == "train":
        ...
        return np.array(depth_frames[:train_size]), train_y, np.array(depth_frames[train_size: train_size + valid_size]), valid_y

    else:
        test_x = depth_frames[train_size + valid_size:]
